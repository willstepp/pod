...
rsync_args="-arvuz $script_dir/../ daniel@writerkata.com:/home/daniel/public/pod.monomyth.io/public --delete --exclude-from $script_dir/exclude.txt"
site_dir='pod.monomyth.io'
